...
function SeoOptimizerClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await axios.post("/api/ai/seo", { content });
      setResult(res.data.seoResult);
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Paste your blog or article content — the AI will analyze SEO score,
            keywords, meta tags, and improvements.
          </p>
        </motion.header>
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">
                    Copy or download the SEO report below.
                  </p>
                </div>
        ...
        {!result && !loading && (
          <p className="mt-6 text-sm text-zinc-500 text-center">
            Tip: Include headings and keywords for better SEO insights.
          </p>
        )}
      </div>
    </motion.main>
...
export default SeoOptimizerClient;
