...
export default function CodeExplainerClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await axios.post("/api/ai/code", {
        code,
        language,
      });
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Paste any code snippet and get a clear, step-by-step explanation in
            simple language.
          </p>
        </motion.header>
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="
                  w-full rounded-xl font-mono text-sm
        ...
        <AnimatePresence>
          {result && (
            ...
            >
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">
                    Copy or download the explanation below.
                  </p>
                </div>
              ...
              <article className="prose prose-zinc max-w-3xl mx-auto prose-lg prose-p:leading-7">
