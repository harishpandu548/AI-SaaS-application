...
export default function MeetingNotesClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await axios.post("/api/ai/meeting-notes", { notes });
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Automatically convert messy meeting transcripts into structured
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
            <div>
              ...
              <textarea
                ...
                placeholder="Paste meeting transcript, call notes, or raw discussion here..."
                className="
                  w-full rounded-xl
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">
                    Summary, action items, and decisions extracted by AI.
                  </p>
                </div>
