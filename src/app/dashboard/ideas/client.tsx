...
export default function IdeaGeneratorClient() {
  ...
  const [category, setCategory] = useState("Startup Ideas");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await axios.post("/api/ai/ideas", {
        topic,
        category,
      });
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Generate startup, content, feature, and monetization ideas instantly
            using AI.
          </p>
        </motion.header>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
            <input
              ...
              placeholder="Topic (e.g. AI SaaS, Fitness, EdTech)"
              className="
                w-full rounded-xl
            ...
            <div className="flex flex-wrap gap-6 items-end pt-4 border-t border-white/30">
              ...
              >
                ...
                <option>Monetization Ideas</option>
              </select>
              ...
              <motion.button
                ...
                className="
                  ml-auto px-6 py-3 rounded-xl font-medium
        ...
        {!result && !loading && (
          <p className="mt-6 text-sm text-zinc-500 text-center">
            Tip: Try <span className="font-medium">Startup Ideas</span> for
            product inspiration or{" "}
            <span className="font-medium">Monetization Ideas</span> for revenue
            strategies.
          </p>
        )}
      </div>
