      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Generate role-based interview questions for technical, HR, and
            behavioral rounds using AI.
          </p>
        </motion.header>
          ...
          <form onSubmit={handleSubmit} className="relative space-y-6">
            ...
            <div className="flex flex-wrap gap-6 items-end pt-4 border-t border-white/30">
              <select
                ...
                className="rounded-xl bg-white/40 backdrop-blur border px-4 py-2"
              >
        ...
        {!result && !loading && (
          <p className="mt-6 text-sm text-zinc-500 text-center">
            Tip: Choose <span className="font-medium">Mixed</span> for complete
