...
export default function GrammarClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await axios.post("/api/ai/grammer", {
        text,
        tone,
      });
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-extrabold text-zinc-900">
            AI Grammar & Tone Improver
          </h1>
          <p className="text-zinc-600 mt-3 max-w-xl mx-auto">
            Fix grammar, improve clarity, and rewrite text in different tones
            instantly using AI.
          </p>
        </motion.header>
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">
                    Copy or download the improved content below.
                  </p>
                </div>
        ...
        {!result && !loading && (
          <p className="mt-6 text-sm text-zinc-500 text-center">
            Tip: Try different tones to match emails, blogs, or social posts.
          </p>
        )}
      </div>
    </motion.main>
